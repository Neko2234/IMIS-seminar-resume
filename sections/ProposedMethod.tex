...
このとき，序論で述べた縮小写像の原理に基づき，ラベルに対して出力が全域で正かつ一定の傾きで追従する「全域的な線形性」，および固定の学習ゲインによる収束の妨げとならない「低い試行間推論分散」の2つの条件が同時に満たされることが，ILC 収束の前提条件となる．

本研究の仮説は，動作データ全体 $\bm{\xi}$ を直接予測するより，ベース動作データからの残差$\Delta\bm{\xi}$ だけを予測する方が，これら2つの条件が強まる，というものである．
